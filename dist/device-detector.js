(function() {
    ...
    exports.getOS = function() {
        ...
        for (i = 0; i < clients.length; i++) {
            if (clients[i].r.test(navigator.userAgent)) {
                return clients[i].s;
            }
        }
        return undefined;
    ...
    exports.getBrowser = function() {
        ...
        var obj = /Opera|OPR|Edge|Edg|MSIE|Chrome|Firefox|Trident\//.exec(navigator.userAgent);
        return obj[0] ? browserAlias[obj[0]] : undefined;
    }

    exports.getBrowserVersion = function() {
        var browser = this.getBrowser();
        var i, offset, version;
        ...
        version = "";
        offset = navigator.userAgent.indexOf(browser);
        for (i = offset + browser.length; i < navigator.userAgent.length; i++) {
            if (navigator.userAgent[i].match(/\s/i)) {
                return version;
            }

            if (
                isNumber(navigator.userAgent[i]) ||
                navigator.userAgent[i].match(/[\.]/i)
            ) {
